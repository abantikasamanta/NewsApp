          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item mx-2"><Link className="nav-Link text-light" to="/health">Health</Link></li>
                <li className="nav-item mx-2"><Link className="nav-Link text-light" to="/science">Science</Link></li>
                <li className="nav-item mx-2"><Link className="nav-Link text-light" to="/sports">Sports</Link></li>
                <li className="nav-item mx-2"><Link className="nav-Link text-light" to="/technology">Technology</Link></li>
